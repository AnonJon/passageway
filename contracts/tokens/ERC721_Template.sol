...
contract ERC721_Template is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = ERC721_Template.ownerOf(tokenId);
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        require(ERC721_Template.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
        ...
        _approve(address(0), tokenId);
        emit Approval(ERC721_Template.ownerOf(tokenId), address(0), tokenId);
